...
| Vercel per-branch preview | ⏳ 待开 | 每个 PR 自动生成预览 URL — Vercel dashboard 5 分钟配置 |
...
| **Vercel preview 配置** | dashboard → Settings → Git → 启用 GitHub integration → 选 encore-hackathon |
