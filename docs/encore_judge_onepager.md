...
| 阶段 / 方案 | 怎么做 | 全量 50K 同时在播月成本 |
|---|---|---|
| **Phase 1 · M9 上线** | 平台信号 → 匹配手工预制模板(粗粒度)| **~$0** 增量 |
| **Phase 2-A · M14+ 最便宜** | 离线 batch 生成 10K+ 模板入库, runtime 99% 命中, 1% Haiku 兜底 | **~$5-15K / 月** |
| **Phase 2-B · M14+ 中等** | Haiku 实时全量 + prompt cache 90% | **~$30-50K / 月** |
| **Phase 2-C · M14+ 较高** | 智能分级:Sonnet for top 10% 顶级高光 + Haiku for rest | **~$75-95K / 月** |
